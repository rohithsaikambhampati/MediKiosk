    ...
    return (
      <div className="w-full flex flex-col gap-1.5">
        ...
        <div className="relative flex items-center">
          {LeftIcon && (
            <div className="absolute left-3 text-clinical-muted pointer-events-none">
          ...
          <input
            ...
            className={cn(
              ...
              isKiosk ? 'h-14 px-4 text-lg rounded-kiosk' : 'h-10 px-3.5 text-sm rounded-clinical',
              LeftIcon && (isKiosk ? 'pl-12' : 'pl-10'),
              RightIcon && (isKiosk ? 'pr-12' : 'pr-10'),
          ...
          />
          {RightIcon && (
            <div className="absolute right-3 text-clinical-muted pointer-events-none">
